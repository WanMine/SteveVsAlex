...
public class VehicleWorkbenchScreen extends AbstractContainerScreen<VehicleWorkbenchContainer> {
    public static final ResourceLocation GUI = new ResourceLocation(MODID, "textures/gui/vehicle_workbench.png");
    private final String resultItem;
    private float rotation = 0f;

    public VehicleWorkbenchScreen(VehicleWorkbenchContainer screenContainer, Inventory inv, Component titleIn) {
