...
public class VehichleRenderer<T extends PlaneEntity> extends EntityRenderer<T> {

    protected final EntityModel<T> vehichleEntityModel;

    public VehichleRenderer(EntityRendererProvider.Context context, EntityModel<T> planeModel, float shadowSize) {
        super(context);
